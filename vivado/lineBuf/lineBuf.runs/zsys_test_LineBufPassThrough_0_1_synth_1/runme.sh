...
HD_PWD='/home/ryunosuke/Works/zynqberrydemo1/vivado/zynqberrydemo1.runs/zsys_test_LineBufPassThrough_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_test_LineBufPassThrough_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_test_LineBufPassThrough_0_1.tcl
