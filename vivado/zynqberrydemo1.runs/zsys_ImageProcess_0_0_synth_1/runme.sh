...
HD_PWD='/home/ryunosuke/Works/zynqberrydemo1/vivado/zynqberrydemo1.runs/zsys_ImageProcess_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_ImageProcess_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_ImageProcess_0_0.tcl
