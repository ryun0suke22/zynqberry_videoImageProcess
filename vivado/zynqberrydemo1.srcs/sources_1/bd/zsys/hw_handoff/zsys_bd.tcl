...
CONFIG.max_lines_per_frame {2048} \
  ...
  connect_bd_net -net ImageProcess_0_o_HBlank [get_bd_pins ImageProcess_0/o_HBlank] [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_hblank]
  connect_bd_net -net ImageProcess_0_o_HSync [get_bd_pins ImageProcess_0/o_HSync] [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_hsync]
  connect_bd_net -net ImageProcess_0_o_VBlank [get_bd_pins ImageProcess_0/o_VBlank] [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_vblank]
  connect_bd_net -net ImageProcess_0_o_VDE [get_bd_pins ImageProcess_0/o_VDE] [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_active_video]
  connect_bd_net -net ImageProcess_0_o_VSync [get_bd_pins ImageProcess_0/o_VSync] [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_vsync]
  connect_bd_net -net ImageProcess_0_o_pixelData [get_bd_pins ImageProcess_0/o_pixelData] [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_data]
  ...
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins ImageProcess_0/Reset] [get_bd_pins Video_IO_2_HDMI_TMDS_0/lock_in] [get_bd_pins clk_wiz_1/locked]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins ImageProcess_0/i_VDE] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins ImageProcess_0/i_pixelData] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hblank [get_bd_pins ImageProcess_0/i_HBlank] [get_bd_pins v_axi4s_vid_out_0/vid_hblank]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins ImageProcess_0/i_HSync] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vblank [get_bd_pins ImageProcess_0/i_VBlank] [get_bd_pins v_axi4s_vid_out_0/vid_vblank]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins ImageProcess_0/i_VSync] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
  connect_bd_net -net v_axi4s_vid_out_0_vtg_ce [get_bd_pins v_axi4s_vid_out_0/vtg_ce] [get_bd_pins v_tc_0/gen_clken]
  connect_bd_net -net video_clk_in_1 [get_bd_pins ImageProcess_0/Clock] [get_bd_pins Video_IO_2_HDMI_TMDS_0/video_clk_in] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
...
CONFIG.C_NUM_PERP_RST {1} \
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_reset [get_bd_pins peripheral_reset] [get_bd_pins rst_processing_system7_0_50M/peripheral_reset]
...
CONFIG.DOUT_WIDTH {1} \
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins audio/axi_resetn] [get_bd_pins axi_reg32_0/s_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins resets/axi_per_aresetn] [get_bd_pins video_in/axi_aresetn] [get_bd_pins video_out/axi_per_aresetn]
