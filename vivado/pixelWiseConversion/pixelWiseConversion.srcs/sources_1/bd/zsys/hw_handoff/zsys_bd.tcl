...
CONFIG.USE_DYN_RECONFIG {true} \
  ...
  # Create instance: negPosInv_0, and set properties
  set block_name negPosInv
  set block_cell_name negPosInv_0
  if { [catch {set negPosInv_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $negPosInv_0 eq "" } {
...
CONFIG.max_lines_per_frame {2048} \
  ...
  connect_bd_net -net negPosInv_0_o_VDE [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_active_video] [get_bd_pins negPosInv_0/o_VDE]
  connect_bd_net -net negPosInv_0_o_pixelData [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_data] [get_bd_pins negPosInv_0/o_pixelData]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins negPosInv_0/i_VDE] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins negPosInv_0/i_pixelData] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hblank [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_hblank] [get_bd_pins v_axi4s_vid_out_0/vid_hblank]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_hsync] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vblank [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_vblank] [get_bd_pins v_axi4s_vid_out_0/vid_vblank]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins Video_IO_2_HDMI_TMDS_0/vid_vsync] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
